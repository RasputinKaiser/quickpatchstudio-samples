# QuickPatchStudio Samples

Fast-turnaround creative and technical support for small web, video, and product tasks.
...
- `samples/youtube-thumbnail-concept.svg` - bold YouTube thumbnail concept sample.
- `samples/vertical-ad-storyboard.md` - short-form ad structure sample.

## Turnaround Style

Work is scoped small, delivered fast, and revised once around a concrete target.
